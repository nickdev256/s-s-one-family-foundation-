...
import { DEFAULT_CONFIGURATION, DEFAULT_RETRY_CONFIG, DEFAULT_LOGGING_OPTIONS, } from './defaultConfiguration.js';
import { ApiLogger, mergeLoggingOptions } from './core.js';
...
export class Client {
    constructor(config) {
        ...
        this._userAgent = updateUserAgent('PayPal REST API TypeScript SDK, Version: 2.4.0, on OS {os-info}');
     ...
     */
    static fromJsonConfig(jsonConfig) {
     ...
     * @returns A new Client instance
     */
    static fromEnvironment(envVariables) {
        return new Client(Configuration.fromEnvironment(envVariables || process.env));
    }
}
