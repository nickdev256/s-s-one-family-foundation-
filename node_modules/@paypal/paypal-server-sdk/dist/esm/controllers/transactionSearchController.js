 ...
 */
import { balancesResponseSchema, } from '../models/balancesResponse.js';
import { searchResponseSchema, } from '../models/searchResponse.js';
...
export class TransactionSearchController extends BaseController {
     ...
     */
    async searchTransactions({ startDate, endDate, transactionId, transactionType, transactionStatus, transactionAmount, transactionCurrency, paymentInstrumentType, storeId, terminalId, fields, balanceAffectingRecordsOnly, pageSize, page, }, requestOptions) {
     ...
     * @return Response from the API call
     */
    async searchBalances({ asOfTime, currencyCode, }, requestOptions) {
        ...
        req.throwOn(400, DefaultError, 'The request is not well-formed, is syntactically incorrect, or violates schema.');
        req.throwOn(403, DefaultError, 'Authorization failed due to insufficient permissions.');
