...
var balancesResponse_js_1 = require("../models/balancesResponse.js");
var searchResponse_js_1 = require("../models/searchResponse.js");
var schema_js_1 = require("../schema.js");
var baseController_js_1 = require("./baseController.js");
var defaultError_js_1 = require("../errors/defaultError.js");
var searchError_js_1 = require("../errors/searchError.js");
var TransactionSearchController = /** @class */ (function (_super) {
    tslib_1.__extends(TransactionSearchController, _super);
     ...
     */
    TransactionSearchController.prototype.searchTransactions = function (_a, requestOptions_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function (_b, requestOptions) {
            var req, mapped;
            var startDate = _b.startDate, endDate = _b.endDate, transactionId = _b.transactionId, transactionType = _b.transactionType, transactionStatus = _b.transactionStatus, transactionAmount = _b.transactionAmount, transactionCurrency = _b.transactionCurrency, paymentInstrumentType = _b.paymentInstrumentType, storeId = _b.storeId, terminalId = _b.terminalId, fields = _b.fields, balanceAffectingRecordsOnly = _b.balanceAffectingRecordsOnly, pageSize = _b.pageSize, page = _b.page;
            return tslib_1.__generator(this, function (_c) {
                req = this.createRequest('GET', '/v1/reporting/transactions');
                mapped = req.prepareArgs({
                    startDate: [startDate, (0, schema_js_1.string)()],
                    endDate: [endDate, (0, schema_js_1.string)()],
                    transactionId: [transactionId, (0, schema_js_1.optional)((0, schema_js_1.string)())],
                    transactionType: [transactionType, (0, schema_js_1.optional)((0, schema_js_1.string)())],
                    transactionStatus: [transactionStatus, (0, schema_js_1.optional)((0, schema_js_1.string)())],
                    transactionAmount: [transactionAmount, (0, schema_js_1.optional)((0, schema_js_1.string)())],
                    transactionCurrency: [transactionCurrency, (0, schema_js_1.optional)((0, schema_js_1.string)())],
                    paymentInstrumentType: [paymentInstrumentType, (0, schema_js_1.optional)((0, schema_js_1.string)())],
                    storeId: [storeId, (0, schema_js_1.optional)((0, schema_js_1.string)())],
                    terminalId: [terminalId, (0, schema_js_1.optional)((0, schema_js_1.string)())],
                ...
                req.query('balance_affecting_records_only', mapped.balanceAffectingRecordsOnly);
                req.query('page_size', mapped.pageSize);
                req.query('page', mapped.page);
                req.defaultToError(searchError_js_1.SearchError, 'The error response.');
                req.authenticate([{ oauth2: true }]);
                return [2 /*return*/, req.callAsJson(searchResponse_js_1.searchResponseSchema, requestOptions)];
            });
        });
    };
    /**
     ...
     * @return Response from the API call
     */
    TransactionSearchController.prototype.searchBalances = function (_a, requestOptions_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function (_b, requestOptions) {
            var req, mapped;
            var asOfTime = _b.asOfTime, currencyCode = _b.currencyCode;
            return tslib_1.__generator(this, function (_c) {
                req = this.createRequest('GET', '/v1/reporting/balances');
                mapped = req.prepareArgs({
                    asOfTime: [asOfTime, (0, schema_js_1.optional)((0, schema_js_1.string)())],
                    currencyCode: [currencyCode, (0, schema_js_1.optional)((0, schema_js_1.string)())],
                });
                req.query('as_of_time', mapped.asOfTime);
                req.query('currency_code', mapped.currencyCode);
                req.throwOn(400, defaultError_js_1.DefaultError, 'The request is not well-formed, is syntactically incorrect, or violates schema.');
                req.throwOn(403, defaultError_js_1.DefaultError, 'Authorization failed due to insufficient permissions.');
                req.throwOn(500, defaultError_js_1.DefaultError, 'An internal server error occurred.');
                req.defaultToError(defaultError_js_1.DefaultError, 'The error response.');
                req.authenticate([{ oauth2: true }]);
                return [2 /*return*/, req.callAsJson(balancesResponse_js_1.balancesResponseSchema, requestOptions)];
            });
        });
    };
...
//# sourceMappingURL=transactionSearchController.js.map