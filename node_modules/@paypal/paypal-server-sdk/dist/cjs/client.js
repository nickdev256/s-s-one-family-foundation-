...
var core_js_3 = require("./core.js");
var core_js_4 = require("./core.js");
var core_js_5 = require("./core.js");
...
var Client = /** @class */ (function () {
    function Client(config) {
        ...
        this._loggingOp = this._config.logging
            ? (0, core_js_1.mergeLoggingOptions)((_b = this._config.logging) !== null && _b !== void 0 ? _b : {})
            : (0, core_js_1.mergeLoggingOptions)((_c = this._config.logging) !== null && _c !== void 0 ? _c : {}, defaultConfiguration_js_1.DEFAULT_LOGGING_OPTIONS);
        this._timeout =
        ...
        this._userAgent = (0, core_js_4.updateUserAgent)('PayPal REST API TypeScript SDK, Version: 2.4.0, on OS {os-info}');
        this._requestBuilderFactory = createRequestHandlerFactory(function (server) { return getBaseUri(server, _this._config); }, (0, authProvider_js_1.createAuthProviderFromConfig)(this._config, function () { return _this.clientCredentialsAuthManager; }), new clientAdapter_js_1.HttpClient(core_js_5.AbortError, {
...
function getBaseUri(server, config) {
    ...
    if (config.environment === configuration_js_1.Environment.Sandbox) {
        if (server === 'default') {
...
function createRequestHandlerFactory(baseUrlProvider, authProvider, httpClient, addons, retryConfig, loggingOptions) {
    var requestBuilderFactory = (0, core_js_5.createRequestBuilderFactory)(createHttpClientAdapter(httpClient), baseUrlProvider, core_js_2.ApiError, authProvider, retryConfig, undefined, new core_js_1.ApiLogger(loggingOptions));
...
function withErrorHandlers(rb) {
    rb.defaultToError(core_js_2.ApiError);
}
function withUserAgent(userAgent) {
    return function (rb) {
        rb.interceptRequest(function (request) {
            ...
            (0, core_js_3.setHeader)(headers, 'user-agent', userAgent);
