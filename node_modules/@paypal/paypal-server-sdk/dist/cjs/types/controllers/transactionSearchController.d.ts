...
import { BalancesResponse } from '../models/balancesResponse.js';
import { SearchResponse } from '../models/searchResponse.js';
import { BaseController } from './baseController.js';
export declare class TransactionSearchController extends BaseController {
    /**
     ...
     */
    searchTransactions({ startDate, endDate, transactionId, transactionType, transactionStatus, transactionAmount, transactionCurrency, paymentInstrumentType, storeId, terminalId, fields, balanceAffectingRecordsOnly, pageSize, page, }: {
        startDate: string;
        endDate: string;
        ...
        pageSize?: number;
        page?: number;
    }, requestOptions?: RequestOptions): Promise<ApiResponse<SearchResponse>>;
    /**
     ...
     * @return Response from the API call
     */
    searchBalances({ asOfTime, currencyCode, }: {
        asOfTime?: string;
        currencyCode?: string;
    }, requestOptions?: RequestOptions): Promise<ApiResponse<BalancesResponse>>;
}
//# sourceMappingURL=transactionSearchController.d.ts.map